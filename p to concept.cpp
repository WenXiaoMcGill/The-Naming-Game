...
{
	strcpy_s(Ntbox,"E:\\高双\\Stubborn2\\Nw");
	strcpy_s(N2tbox,"E:\\高双\\Stubborn2\\Nd");
	strcpy_s(N3tbox,"E:\\高双\\Stubborn2\\St");
	...
	strcat_s(N2tbox,number);
	strcat_s(N3tbox,number);
	cout<<Ntbox<<endl;
	cout<<N2tbox<<endl;
	cout<<N3tbox<<endl;
}
...
void main()//************************************
{
	...
	//生成文件夹
	_mkdir("E:\\高双\\");
	_mkdir("E:\\高双\\Stubborn2");
	strcpy_s(Threebox,"E:\\高双\\Stubborn2\\three.txt");
